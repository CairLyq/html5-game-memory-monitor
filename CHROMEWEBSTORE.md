...
|---------|------|---------|--------|
| 1.7.1 | 2026-09-08 | 纹理来源深入解析：跳过引擎封装帧，显示业务侧调用帧；修复 CSV 中文标题乱码（UTF-8 BOM）；修复导出 undefined | Draft |
| 1.7.0 | 2026-09-08 | 改为按需启用：网站白名单（逐站授权）+ 点击图标临时监测；HUD 默认关闭；安装时零网站权限警告；LayaAir 3.x 逐层压缩纹理尺寸/显存修复 | Draft |
